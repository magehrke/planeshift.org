...
<html>
<head>
	<title>Making Metal Stock in Ojaveda</title>
			...
			<div id="root_site_container">
				...
				<div id="content_main_container">
					...
					<tr class="quest_title">
						<td>Making Metal Stock in Ojaveda</td>
					</tr>
					...
					<tr class="quest_you">
						<td>YOU: Yes I’ll pay you that.</td>
					</tr>
					<tr class="quest_emptyRow_btwNpcYou">
						<td></td>
					</tr>
					...
					<tr class="quest_npc">
						<td>Trasok: Stock is made of five or ten molten pieces depending on the metal type.</td>
					</tr>
					<tr class="quest_npc">
					...
					<tr class="quest_you">
						<td>YOU: Yes I’m ready for more.</td>
					</tr>
					<tr class="quest_emptyRow_btwNpcYou">
						<td></td>
					</tr>
					...
					<tr class="quest_npc">
						<td>Trasok: To make one piece of metal stock, you have to place five or ten molten pieces of ore into the same stock casting slot.</td>
					</tr>
					<tr class="quest_npc">
						<td>Trasok: So one molten piece will make an ingot, and five or ten pieces will make a bar of metal stock.</td>
					</tr>
					<tr class="quest_npc">
					...
					<tr class="quest_reward">
						<td>Rewards: 15 Faction with Crafting Association, 10800 XP.</td>
					</tr>
