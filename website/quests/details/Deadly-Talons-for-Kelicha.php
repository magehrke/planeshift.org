...
<html>
<head>
	<title>Deadly Talons for Kelicha</title>
			...
			<div id="root_site_container">
				...
				<div id="content_main_container">
					...
					<tr class="quest_title">
						<td>Deadly Talons for Kelicha</td>
					</tr>
					...
					<tr class="quest_storyline">
						<td>- Kelicha Anijiel's shoulders slump as she turns to you with an exasperated sigh.</td>
					</tr>
					...
					<tr class="quest_npc">
						<td>Kelicha: eally good.</td>
					</tr>
					<tr class="quest_npc">
						<td>Kelicha: Are you?</td>
					</tr>
					<tr class="quest_emptyRow_btwNpcYou">
						<td></td>
					</tr>
					...
					<tr class="quest_npc">
						<td>Kelicha: There will be some rocks and an maulbernaut encampment.</td>
					</tr>
					<tr class="quest_npc">
					...
					<tr class="quest_storyline">
						<td>- Kelicha Anijiel turns back to the mechanisms.</td>
					</tr>
					<tr class="quest_emptyRow_afterStoryline">
						<td></td>
					</tr>
					...
					<tr class="quest_action">
						...
						<?php
							...
							echo "' target='_blank'>Kelicha Anijiel</a>";
						?>
						3 Maulbernaut Talons</td>
					</tr>
					<tr class="quest_emptyRow_afterAction">
						<td></td>
					</tr>
					<tr class="quest_you">
						<td>YOU: Here are three more claws. My goodness, my sword arm aches!</td>
					</tr>
					<tr class="quest_emptyRow_btwNpcYou">
						<td></td>
					</tr>
					...
					<tr class="quest_action">
						...
						<?php
							...
							echo "' target='_blank'>Kelicha Anijiel</a>";
						?>
						2 Maulbernaut Talons</td>
					</tr>
					<tr class="quest_emptyRow_afterAction">
						<td></td>
					</tr>
					<tr class="quest_you">
						<td>YOU: Huarwar sighs and rubs his sword arm as Kelicha picks up the claws.</td>
					</tr>
					<tr class="quest_emptyRow_btwNpcYou">
						<td></td>
					</tr>
					...
					<tr class="quest_storyline">
						<td>- Kelicha Anijiel puts them down to one side.</td>
					</tr>
					<tr class="quest_emptyRow_afterStoryline">
						<td></td>
					</tr>
					...
					<tr class="quest_npc">
						<td>Kelicha: I have one item you might like.</td>
					</tr>
					<tr class="quest_emptyRow_afterNpcYou">
						<td></td>
					</tr>
					<tr class="quest_storyline">
						<td>- Kelicha Anijiel hands it to you as she rubs her wings together in anticipation.</td>
					</tr>
					<tr class="quest_emptyRow_afterStoryline">
						<td></td>
					</tr>
					...
					<tr class="quest_reward">
						<td>Rewards: 1 Net Glyph, 9922 Tria, 16400 XP.</td>
					</tr>
