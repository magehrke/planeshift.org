                    ...
                    <table class="maps_main_table">
                        ...
                        <tr>
                            ...
                            <td class="info_section">
                                ...
                                <span class="selectLayer selected" data-which="4">Layer 3</span><br>
                                <span class="selectLayer selected" data-which="5">Layer 4</span><br>
                                <span class="selectLayer selected" data-which="6">Layer 5</span><br>
                                <span class="selectLayer selected" data-which="1">Backgr.</span><br>

                                <!-- Extract the npcs (name and postion) from database for Amdeneir-->
