...
<html>
<head>
	<title>Bronze Doors Fortress</title>
    ...
    <script>
        ...
        offsetX = 123000, 
        offsetY = 25500, 
        map = "/images/maps/bdfortress.jpg", 
        rot = false, 
        layers = 1,
        hiddenLayers = [];
    </script>
                    ...
                    <table class="maps_main_table">
                        ...
                        <tr>
                            <td class="map_section">
                                <h1>Map of Bronze Doors Fortress</h1>
                                <div id="myWrapper">
