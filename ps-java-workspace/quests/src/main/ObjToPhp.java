...
public class ObjToPhp {
	...
	public void createAllQUestDetailsFiles(ArrayList<Quest> quests) {
		for(int i = 0; i < quests.size(); i++) {
			
			//Select the current quest object
			createQuestDetailsFile(quests.get(i), utilities.Constants.PATHtoPHPdetails);
		}
			
			
	}
	
	static public void createQuestDetailsFile(Quest currQuest, String savingFolder) {
		...
		StringBuffer filename = new StringBuffer(savingFolder);
